...
const EMAILJS_SERVICE_ID = 'service_borom';
const EMAILJS_TEMPLATE_ID = 'template_borom';
...
export default function Contact() {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/rop-borom-269411289/',
      icon: FaLinkedin,
      color: 'hover:text-blue-600'
    },
    {
      name: 'Telegram',
      url: 'https://t.me/borom_1111',
      icon: FaTelegram,
